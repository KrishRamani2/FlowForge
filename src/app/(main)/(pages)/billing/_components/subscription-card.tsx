              ...
              <CardDescription>
                {product.nickname == 'Unlimited'
                  ...
                  : product.nickname == 'Free' &&
                    "Get a monthly wave of credits to automate your tasks with ease. Perfect for starters looking to dip their toes into FlowForge's automation capabilities."}
              </CardDescription>
